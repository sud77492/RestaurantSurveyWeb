  ...
  if(isset($_POST['submit'])){
      $sql = mysqli_query($con, "UPDATE tbl_users SET usr_restaurant_name = '".$_POST['restaurant']."', usr_mobile = '".$_POST['mobile']."',usr_name = '".$_POST['name']."', usr_modified_at = '".$date."' WHERE usr_id = '".$_SESSION['user_id']."'");
      if($sql){
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="#">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" value="<?php echo $row['usr_name'];?>" id="exampleInputUsername1" placeholder="Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Email address</label>
                      <input type="email" class="form-control" name="email" value="<?php echo $row['usr_email'];?>" id="exampleInputEmail1" placeholder="Email" disabled>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputMobile1">Mobile</label>
                      <input type="text" class="form-control" name="mobile" value="<?php echo $row['usr_mobile'];?>" id="exampleInputMobile1" placeholder="Mobile">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputText1">Restaurant Name</label>
                      <input type="text" class="form-control" name="restaurant" value="<?php echo $row['usr_restaurant_name'];?>" id="exampleInputText1" placeholder="Restaurant Name">
                    </div>
